  ...
  describe "Access Control" do
    describe "PATCH #update" do
      ...
      it "doesn't let user update other users post and raise an error" do
        ...
        expect do
          patch :update, params: {id: others_post.id, post: {title: "hello", body: "world"}}, xhr: true
        end.
  ...
  context "when user is logged-in" do
    ...
    describe "updating published posts" do
      before :each do
        ...
        patch :update, params: {id: published_post.id, post: { title: "updated title", body: "updated body" }}, xhr: true
